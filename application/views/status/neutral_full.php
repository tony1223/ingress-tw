...
<div style="margin-top:-10px;height:95%;width:100%;">
	<a class="btn" href="<?=site_url("status/neutral")?>">回一般瀏覽模式</a>
	<div id="map-canvas" class="gmap" data-resource="<?=htmlspecialchars("http://ingress.tw/static/white/white_latest.kmz?t=".date("Ymd_Hi"))?>"></div>
