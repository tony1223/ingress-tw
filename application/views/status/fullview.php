...
<div style="margin-top:-10px;height:95%;width:100%;">
	<a class="btn" href="<?=site_url("status/view/".$info->HistoryID)?>">回一般瀏覽模式</a> <?=htmlspecialchars(_date_format($info->CreateDate))?> <?=htmlspecialchars($info->Title)?>
	<div id="map-canvas" class="gmap" data-resource="<?=htmlspecialchars($info->KML)?>"></div>
